...
#---------------------------------------------------------------------------------------
# https://www.pdftron.com/documentation/python/get-started/python3/windows
...
def main():
    ...
    input_path = "D:\\UP\\CERTYFIKATY\\"
    output_path = "D:\\UP\\CERTYFIKATY\\"
    input_filename = "workandtravel"
